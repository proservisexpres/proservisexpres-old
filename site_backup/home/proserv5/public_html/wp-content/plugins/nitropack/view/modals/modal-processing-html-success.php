...
?>
<div id="processing-html-success-modal" data-modal-backdrop="" tabindex="-1" aria-hidden="true"
	...
	<div class="popup-container">
		<div class="popup-inner">
			...
			<div class="popup-footer">
				<button type="button"
					class="btn btn-primary close-modal"><?php esc_html_e( 'Continue', 'nitropack' ); ?></button>
			</div>
			<?php if ( $is_free_plan ) : ?>

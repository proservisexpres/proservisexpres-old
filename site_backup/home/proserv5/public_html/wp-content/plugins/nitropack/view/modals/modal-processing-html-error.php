	...
	<div class="popup-container">
		<div class="popup-inner">
			...
			<div class="popup-footer">
				<button type="button" class="btn btn-primary modal-action close-modal"><?php esc_html_e( 'Try again', 'nitropack' ); ?></button>
				<button type="button" class="btn btn-secondary contact-support close-modal"><?php esc_html_e( 'Contact Support', 'nitropack' ); ?></button>
			</div>
		</div>
	</div>
</div>